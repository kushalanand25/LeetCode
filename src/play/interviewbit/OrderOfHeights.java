...
public class OrderOfHeights {
	...
	public static void main(String[] args) {
		OrderOfHeights inst	= new OrderOfHeights();
        System.out.println(inst.order(new ArrayList<>(Arrays.asList(5,3,2,6,1,4)), new ArrayList<>(Arrays.asList(0,1,2,0,3,2))));
        System.out.println(inst.order(new ArrayList<>(Arrays.asList(86, 92, 49, 21, 62, 27, 90, 59)), new ArrayList<>(Arrays.asList(2, 0, 0, 2, 0, 2, 1, 3))));
    }
}
